...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			i := handler.NewInfo(tt.fields.state)
// 			if err := i.Register(tt.args.h); (err != nil) != tt.wantErr {
// 				t.Errorf("Info.Register() error = %v, wantErr %v", err, tt.wantErr)
// 			}
// 		})
// 	}
// }
